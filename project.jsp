...
String sql="select description from create_issue";
//String sql="select description from create_issue where project_name = ?";
PreparedStatement ps = connection.prepareStatement(sql);
ResultSet rs = ps.executeQuery();
String result[] = new String[30];
int abc=0;
ArrayList<String> a = new ArrayList();
int i_dimen=0,j_dimen=0;
while (rs.next())
{  
	++j_dimen;
	a.clear();
    ...
    a = sort(a);
   	//result[j_dimen] = a.set(i_dimen, a.get(i_dimen));
   	out.println(a);
   	out.println("<br/>");
}
/*for(int t=1;t <=4;++t)
